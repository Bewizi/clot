...
mixin ColorBtnSheetModal {
  void showColorModalSheet(BuildContext context) {
    showModalBottomSheet(
      context: context,
      builder: (context) {
        // Use a StatefulBuilder so the modal can keep local selected state
        String? selectedLabel = 'Orange';

        return StatefulBuilder(
          builder: (context, setState) {
            Widget colorItem(String label) => _buildColorItem(
              label,
              context,
              selectedLabel == label,
              ...
              child: Column(
                children: [
                  Row(
                    ...
                    children: [
                      Expanded(
                        child: TextMedium('Color', textAlign: TextAlign.center),
                      ),
                      GestureDetector(
                        onTap: () => context.pop(),
