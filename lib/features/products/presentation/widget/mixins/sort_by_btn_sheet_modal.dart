...
mixin SortByBtnSheetModal {
  void showSortByModalSheet(BuildContext context) {
    showModalBottomSheet(
      context: context,
      builder: (context) {
        // Use a StatefulBuilder so the modal can keep local selected state
        String? selectedLabel = 'Recommended';

        return StatefulBuilder(
          builder: (context, setState) {
            Widget sortItem(String label) => _buildSortByItem(
              label,
              context,
              selectedLabel == label,
            ...
            return Container(
              ...
              child: Column(
                children: [
                  ...
                  Column(
                    children: [
                      sortItem('Recommended'),
                      sortItem('Newest'),
                      sortItem('Lowest - Highest Price'),
                      sortItem('Highest - Lowest Price'),
                    ],
                  ),
                ],
              ),
